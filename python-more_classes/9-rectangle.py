#!/usr/bin/python3
"""
Defines a class Rectangle with a class method to create a square.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        return "\n".join([symbol_line] * self.__height)
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Compares two rectangles and returns the larger one by area."""
